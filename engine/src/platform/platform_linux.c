    ...
    i32 height)
{
    ...
    // XCB_CW_BACK_PIXEL = filling the winnow bg with a single color.
...
void platform_shutdown(platform_state* plat_state)
{
    ...
    if (state) {
        ...
        // connection handling is handled.
...
{
    // FATAL,ERROR,WARM,INFO,DEBUG,TRACE
    static const char* color_strings[] = { "0;41", "1;31", "1;33", "1;32", "1;34", "1;30" };
